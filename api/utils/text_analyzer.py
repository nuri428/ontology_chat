...
# 중요도가 높은 명사들 (범용적 비즈니스 용어)
HIGH_IMPORTANCE_NOUNS = {
    # 비즈니스 핵심 용어
    "수출": 2.8, "해외": 2.3, "글로벌": 2.3, "국제": 2.3,
    "종목": 2.8, "주식": 2.8, "투자": 2.5, "시장": 2.3,
    "성장": 2.3, "전망": 2.5, "유망": 2.5,
    # 산업 용어
    "산업": 2.5, "제조": 2.3, "기술": 2.3, "혁신": 2.3,
    "제품": 2.0, "서비스": 2.0, "솔루션": 2.0,
    # 기업 용어
    "기업": 2.5, "회사": 2.3, "스타트업": 2.3, "연구개발": 2.3
}
...
def _estimate_pos(word: str) -> str:
    ...
    # 회사명 패턴 (일반적 패턴)
    company_patterns = ['전자', '시스템', '그룹', '홍딩스', '코퍼레이션', '비즈니스']
...
def suggest_related_terms(word: str) -> List[str]:
    ...
    related_terms = {
        ...
        "기술": ["혁신", "연구개발", "R&D", "디지털", "인공지능"],
        "산업": ["제조", "생산", "바이오", "IT", "에너지"],
        "성장": ["전망", "기대", "잠재력", "발전", "확장"],
        "제품": ["서비스", "솔루션", "플랫폼", "시스템", "애플리케이션"]
    }
